...
// vendored-quiet: suppress the fork's pre-existing lint noise (see workspace Cargo.toml [patch] note)
#![allow(unused_imports, deprecated, unused_variables, dead_code)]
