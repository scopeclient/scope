...
///
/// // ensure a valid token is in fact a valid format (the example token is
/// // upstream serenity's fake, split so secret scanners don't shape-match it):
/// let token = ["Mjg4NzYwMjQxMzYzODc3ODg4", "C_ikow", "j3VupLBuE1QWZng3TMGH0z_UAwg"].join(".");
