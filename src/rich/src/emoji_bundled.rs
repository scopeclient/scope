//! Generated from `assets/emoji/twemoji/` — Twemoji codes bundled with the app. Do not edit by hand.

pub const TWEMOJI_TAG: &str = "v17.0.3";

/// Sorted, so `binary_search` works.
